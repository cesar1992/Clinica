...
File reportFile = new File(application.getRealPath("reportes/especialidades_doctor.jasper"));
//configuramos los parametros en una varible de tipo Map
//que como un array

int parametro = Integer.parseInt(request.getParameter("txtEspecialidad"));
Map parameters = new HashMap();
parameters.put("txtEspecialidad", parametro);
...
response.setHeader("Content-Disposition", "inline; filename=especialidades_doctor.pdf");
