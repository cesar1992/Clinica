...
File reportFile = new File(application.getRealPath("reportes/ultimas_consultas.jasper"));
...
response.setHeader("Content-Disposition", "inline; filename=ultimas_consultas.pdf");
