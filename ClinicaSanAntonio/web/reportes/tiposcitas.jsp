...
File reportFile = new File(application.getRealPath("reportes/tiposcitas.jasper"));
//configuramos los parametros en una varible de tipo Map
//que como un array

int parametro = Integer.parseInt(request.getParameter("txtTipoCita"));
Map parameters = new HashMap();
parameters.put("txtTipoCita", parametro);
...
response.setHeader("Content-Disposition", "inline; filename=tiposcitas.pdf");
