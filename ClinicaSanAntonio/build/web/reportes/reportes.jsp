...
File reportFile = new File(application.getRealPath("reportes/todos_los_usuarios.jasper"));
...
response.setHeader("Content-Disposition", "inline; filename=todos_los_usuarios.pdf");
