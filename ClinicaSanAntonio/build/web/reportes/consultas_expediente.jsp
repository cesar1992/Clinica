...
File reportFile = new File(application.getRealPath("reportes/consultas_expediente.jasper"));
...
response.setHeader("Content-Disposition", "inline; filename=consultas_expediente.pdf");
